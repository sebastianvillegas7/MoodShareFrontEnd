...
export class LastFMService {
  ...
  getLastReleases(): Observable<SearchResponse> {  
    // https://api.discogs.com/database/search?type=release&sort=year,desc&per_page=4&page=1
    return this.http.get<SearchResponse>(`${URL_API_DISCOGS}database/search?type=release&sort=year,desc&per_page=4&page=1`, DISCOGS_API_HEADERS); // TODO: convertir aleatorio
